...
This document provides the governance policy for specifications and other documents or artifacts, such as a web page or source code, developed using the Community Specification process in a repository (each a “Working Group”).  Each Working Group and must adhere to the requirements in this document.
...
**4.1.	Pre-Draft.**  Any Participant may submit a proposed initial draft document or other suitable artifact as a candidate Draft Specification of that Working Group.  The Maintainer will designate each submission as a “Pre-Draft”.

**4.2.	Draft.**  Each Pre-Draft of a Working Group must first be Approved to become a "Draft Specification".  Once the Working Group approves a document or artifact as a Draft Specification, the Draft Specification becomes the basis for all going forward work on that specification.
